   ...
   <footer class="footer-area section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 single-footer-widget text-left">
                    <h4>Popular News</h4>
                    <ul>
                        <?php if(isset($popularPosts) && !empty($popularPosts)) { ?>
                            <?php foreach ($popularPosts as $popularPost) { ?>
                            <li><a href="<?= url('show-post/' . $popularPost['id']) ?>"><?= $popularPost['title'] ?></a></li>
                            <?php } ?>
                        <?php } else { ?>
                            <li><span class="text-muted">Chưa có tin tức phổ biến</span></li>
                        <?php } ?>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-4 single-footer-widget text-left">
    ...
    <script src="<?= asset('public/app/js/custom-header.js') ?>"></script>
</body>
